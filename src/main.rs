...
0x61, 0x70, 0x74, 0x61, 0x69, 0x6E];
const BAZI: [u8; 14] = [0x42, 0x61, 0x73, 0x69, 0x6C, 0x69, 0x73, 0x6B,
 0x2D, 0x52, 0x69, 0x64, 0x65, 0x72];
...
const LAST: [u8; 14] = [0x4C, 0x45, 0x47, 0x45, 0x4E, 0x44, 0x41, 0x52,
 0x59, 0x5F, 0x42, 0x4F, 0x53, 0x53];
const FLOOR: [u8; 15] = [0x41, 0x56, 0x41, 0x5F, 0x54, 0x45, 0x4D, 
0x50, 0x4C, 0x45, 0x5F, 0x45, 0x58, 0x49, 0x54];
...
fn main() -> Result<(), slint::PlatformError>{
    ...
    app.on_parse(move || {
        ...
        app.set_parsed_string(SharedString::from(in_string.unwrap()));
    });
